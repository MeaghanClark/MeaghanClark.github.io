...
::: {.column-margin}
![photo credit: Dr. Brooke Weigal](images/meaghankelp.jpg){fig-align="left" fig-alt="A woman smiling on a boat holding a strand of giant kelp up to the camera"}
:::
...
This work was recently published! You can read more about it [here](https://www.pnas.org/doi/10.1073/pnas.2501745122).

::: {.column-margin}
![photo credit: Andres Vega](images/retf.jpg){fig-align="left" fig-alt="two frogs, in amplexus, sitting on a leaf. Their blue and yellow flanks are visible."}
:::
...
Read more [here](https://onlinelibrary.wiley.com/doi/full/10.1111/eva.13754).
